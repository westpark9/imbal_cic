...
class BaselineModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.backbone.fc = nn.Linear(in_features, 100)
...
class FinalExperiment:
    ...
    def get_clustering_groups(self, seed):
        ...
        self.set_random_seed(seed + 100)  # Offset seed for warmup
    ...
    def train_expert_ensemble(self, expert_groups, seed, epochs=1):
        ...
        for epoch in range(epochs):
            ...
            for data, targets in train_loader:
                ...
                # Expert predictions
                final_logits = torch.zeros(data.size(0), 100, device=self.device)
    ...
    def evaluate_model(self, model):
        ...
        per_class_acc, per_class_f1 = self.compute_per_class_metrics(
            all_predictions, all_targets, 100
        )
...
def main():
    ...
    parser.add_argument(
        "--num_experts", type=int, default=3, help="Number of expert networks"
    )
    parser.add_argument(
        "--imbalance_factor",
        type=int,
