...
def prepare(data, out, dataset='ton_iot'):
    ...
    X, names, tr, va, te, _, _, audit, label = getattr(core, {'cic2018': 'load_cic2018', 'ton_iot': 'load_ton_iot'}[dataset])(args)
...
def install_clean_loader(core, manifest_path):
    ...
    loader_name = {'cic2018': 'load_cic2018', 'ton_iot': 'load_ton_iot'}[meta['dataset']]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', choices=['cic2018', 'ton_iot'], default='ton_iot')
