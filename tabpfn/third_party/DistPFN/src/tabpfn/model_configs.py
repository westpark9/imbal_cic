# Modified from https://github.com/automl/TabPFN/blob/main/tabpfn/model_configs.py
...
from tabpfn.priors.differentiable_prior import (
    DifferentiableHyperparameter, replace_differentiable_distributions)
