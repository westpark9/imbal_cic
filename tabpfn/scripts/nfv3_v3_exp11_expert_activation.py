#!/usr/bin/env python3
"""EXP11 -- Does the right expert ACTIVATE?  (user regrouping, closed-set)
...
Artifacts:
  ...
  scores_dump.npz                   per-class per-expert gate scores
    ...
    python tabpfn/nfv3_v3_exp11_expert_activation.py --target-dataset cic2018 \\
...
def run_exp11(args):
    ...
    args.experiment = "exp11_expert_activation"
